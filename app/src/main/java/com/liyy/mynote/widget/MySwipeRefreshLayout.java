package com.liyy.mynote.widget;
...
public class MySwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    OnOverScrollTopListener mOnOverScrollTopListener;
    ...
    public void setOnOverScrollTopListener(OnOverScrollTopListener onOverScrollTopListener) {
        mOnOverScrollTopListener = onOverScrollTopListener;
    }
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        if (overscrollTop < mTotalDragDistance) {
            mProgress.setPlusEnabled(false);
            if (mProgress.getAlpha() > STARTING_PROGRESS_ALPHA
                    && !isAnimationRunning(mAlphaStartAnimation)) {
                // Animate the alpha
                startProgressAlphaStartAnimation();
            }
        } else if (overscrollTop > mTotalDragDistance * 2) {
            mProgress.setPlusEnabled(true);
        } else {
    ...
    private void finishSpinner(float overscrollTop) {
        if (mProgress.getPlusEnabled()) {
            cancelRefresh();
            if (mOnOverScrollTopListener != null) {
                mOnOverScrollTopListener.onOverScroll();
            }
    ...
    public interface OnChildScrollUpCallback {
         ...
         *
         * @param parent MyRefreshLayout that this callback is overriding.
         * @param child The child view of MyRefreshLayout.
         *
