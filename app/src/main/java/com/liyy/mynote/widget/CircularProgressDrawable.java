...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public boolean getPlusEnabled() {
        return mRing.getShowPlus();
    }

    public void setPlusEnabled(boolean show) {
        mRing.setShowPlus(show);
        invalidateSelf();
    }
    ...
    private static class Ring {
        ...
        void drawPlus(Canvas c, Rect bounds) {
            float arcRadius = mRingCenterRadius + mStrokeWidth / 2f;
            arcRadius = arcRadius / 2f;
            if (mShowPlus) {
                c.drawLine(bounds.centerX() - arcRadius, bounds.centerY(), bounds.centerX() + arcRadius, bounds.centerY(), mPaint);
                c.drawLine(bounds.centerX(), bounds.centerY() - arcRadius, bounds.centerX(), bounds.centerY() + arcRadius, mPaint);
            }
        }
